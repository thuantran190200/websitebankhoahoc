  ...
  <section class="hoc clear"> 
    ...
    <nav id="mainav">
      <ul class="clear">
        ...
        <li><a href="#">Mâm Xe</a></li>
        <li><a href="#">Ốc Titan</a></li>
        <li><a href="#">Đồ Chơi Xe</a></li>
        <li><a href="voxe.html">Vỏ Xe</a></li>
      </ul>
    </nav>
    <!-- ################################################################################################ -->
    <div id="searchform">
    ...
    <div class="content"> 
      ...
      <div id="gallery">
        <figure>
          ...
          <ul class="nospace clear">
            <li class="one_quarter first"><a href="#"><img src="../images/demo/backgrounds/mam.jpg" alt=""></a></li>
            <li class="one_quarter"><a href="#"><img src="../images/demo/backgrounds/x1r.jpg" alt=""></a></li>
            <li class="one_quarter"><a href="#"><img src="../images/demo/backgrounds/x1rwin.jpg" alt=""></a></li>
